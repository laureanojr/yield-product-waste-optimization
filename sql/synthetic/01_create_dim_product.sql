...
OPTIONS (
  description = "Product master for the SYNTHETIC manufacturing layer. 29 manufacturable products, selected as top-30 by real v1 units minus CAFE OU EAU (a drink — no meaningful production rate or scrap). Covers ~89.5% of real v1 units and ~75.9% of real v1 revenue. unit_cost_eur and ideal_units_per_hr are FABRICATED standards, not real bakery figures. v1_total_units is the only real value in this table, used to shape synthetic demand — real data informs the shape of the simulation, never its contents."
);
